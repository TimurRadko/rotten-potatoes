...
INSERT INTO `films`(title, director, poster, avg_rate)
values ('The Lord of the Rings: The Two Towers', 'Peter Jackson', 'static/images/Lord_of_the_Rings_-_The_Two_Towers_(2002).jpg',8.7);

INSERT INTO `films`(title, director, poster, avg_rate)
values ('Star Wars: Episode V - The Empire Strikes Back', 'Irvin Kershner', 'static/images/SW_-_Empire_Strikes_Back.jpg',8.7);
...
INSERT INTO `films`(title, director, poster, avg_rate)
values ('One Flew Over the Cuckoo''s Nest', 'Milos Forman', 'static/images/One_Flew_Over_the_Cuckoo''s_Nest_poster.jpg',8.7);
...
UPDATE films SET id=2, title='The Godfather', director='Francis Ford Coppola', poster='static/images/godfather.jpg', avg_rate=9.2 WHERE id=2;